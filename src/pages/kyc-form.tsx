...
const KYCForm = () => {
  ...
  const {
    data: kycMatch,
    isLoading: loadingKycMatch,
    refetch: refetchKycMatch,
  } = useQuery({
  ...
  const rawOcrFieldMap: Record<
    string,
    { ocrData: (m: any) => any; key: string }
  > = {
    gender: {
                  ...
                  <Form.Item label="Jenis Kelamin" name={["gender"]}>
                    <div className="flex items-center gap-3">
                      ...
                      <Switch
                        ...
                        onClick={() => {
                          const ocrValue =
                            rawOcrFieldMap.gender.ocrData(kycMatch);
                          if (ocrValue) {
                            mutateUpdateRawOcr({
                            ...
                            notification.warning({
                              message: "No OCR data for Gender",
                            });
                          }
                        }}
                      />
                  ...
                  <Form.Item label="Golongan Darah" name={["bloodGroup"]}>
                    <div className="flex items-center gap-3">
                      ...
                      <Switch
                        ...
                        onClick={() => {
                          const ocrValue =
                            rawOcrFieldMap.bloodGroup.ocrData(kycMatch);
                          if (ocrValue) {
                            mutateUpdateRawOcr({
                            ...
                            notification.warning({
                              message: "No OCR data for Blood Group",
                            });
                          }
                        }}
                      />
                ...
                <div className="grid grid-cols-2 gap-x-4">
                    ...
                    <div>
                      <InputMatch
                        ...
                        onCheck={() => {
                          mutateUpdateRawOcr({
                            key: "rtrw",
                            value: `${kyc?.idCardAddress?.rtNumber}/${kyc?.idCardAddress?.rwNumber}`,
                          });
                        }}
                      />
                    </div>
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <Switch
                      ...
                      onClick={() => {
                        const ocrValue =
                          rawOcrFieldMap["idCardAddress.city"].ocrData(
                            kycMatch,
                          );
                        if (ocrValue) {
                          mutateUpdateRawOcr({
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <Switch
                      ...
                      onClick={() => {
                        const ocrValue =
                          rawOcrFieldMap["idCardAddress.district"].ocrData(
                            kycMatch,
                          );
                        if (ocrValue) {
                          mutateUpdateRawOcr({
                          ...
                          notification.warning({
                            message: "No OCR data for District",
                          });
                        }
                      }}
                    />
                  ...
                  <Form.Item label="Agama" name={["religion"]}>
                    <div className="flex items-center gap-3">
                      ...
                      <Switch
                        ...
                        onClick={() => {
                          const ocrValue =
                            rawOcrFieldMap.religion.ocrData(kycMatch);
                          if (ocrValue) {
                            mutateUpdateRawOcr({
                            ...
                            notification.warning({
                              message: "No OCR data for Religion",
                            });
                          }
                        }}
                      />
                  ...
                  <Form.Item label="Pekerjaan" name={["occupation"]}>
                    <div className="flex items-center gap-3">
                      ...
                      <Switch
                        ...
                        onClick={() => {
                          const ocrValue =
                            rawOcrFieldMap.occupation.ocrData(kycMatch);
                          if (ocrValue) {
                            mutateUpdateRawOcr({
                            ...
                            notification.warning({
                              message: "No OCR data for Occupation",
                            });
                          }
                        }}
                      />
